...
public class ServiceUnavailableAlertException extends ErrorResponseException {
    ...
    public ServiceUnavailableAlertException(URI type, String defaultMessage, String entityName, String errorKey) {
        super(
